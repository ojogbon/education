                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class=""><a href="staff.php">Student</a></li>
                                    <li class="active">Payment Fee</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card alert">
                                    ...
                                    <div class="basic-form">
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <p>Amount </p>
                                                <input type="number" name="lastname" class="form-control input-default " placeholder="Last Name" required>
                                            </div>
								...
								<button type="submit" name="add_staff" class="btn btn-primary btn-flat m-b-30 m-t-30">Post Payment</button>
                                        </form>
                                        <?php
